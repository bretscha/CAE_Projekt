...
public class GUI {
	...
	try {
	    m.read(new FileInputStream(new File(ImporterBase.getRdfOutputPath())), "RDF/XML");
	...
	// *******************************************ACHTUNG*********************************************
	// TODO jena kann auch RDF/XML einlesen. Es ist also nicht notwendig den File
	// als TTL zu transformieren.

	// try {
	// m.write(new FileOutputStream(new File("!!")), "TTL");
	// } catch (FileNotFoundException e) {
	// // TODO Auto-generated catch block
	// e.printStackTrace();
	// }
